...
app.post("/calculate", (request, response) => {
    ...
    const subIntMark1 = parseInt(request.body.subIntMark1)
    const subIntMark2 = parseInt(request.body.subIntMark2)
    const subIntMark3 = parseInt(request.body.subIntMark3)
    const subSemMark1 = parseInt(request.body.subSemMark1)
    const subSemMark2 = parseInt(request.body.subSemMark2)
    const subSemMark3 = parseInt(request.body.subSemMark3)
